...
check: native
	...
	./$(BUILD)/check_apply
	$(CC_NATIVE) $(CFLAGS_NATIVE) tests/check_rttcap.c \
		src/rttcap.c src/tcpstat.c src/log.c src/util.c -o $(BUILD)/check_rttcap
	./$(BUILD)/check_rttcap
	$(CC_NATIVE) $(CFLAGS_NATIVE) tests/check_sockrtt.c \
		src/sockrtt.c -o $(BUILD)/check_sockrtt
	./$(BUILD)/check_sockrtt
