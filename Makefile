...
check: native
	...
	./$(BUILD)/check_tcpstat
	$(CC_NATIVE) $(CFLAGS_NATIVE) tests/check_probe.c \
		src/probe.c src/util.c -o $(BUILD)/check_probe
	./$(BUILD)/check_probe
