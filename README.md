...
Этапы 1–4 из 5. Готово: пакет и сборка под три архитектуры, своя сборка ядра
Xray, разбор share-ссылок и подписок, генерация и безопасная подмена конфига,
надзор за процессом ядра, списки доменов и подсетей, наполнение ipset,
правила маршрутизации, перехват DNS-ответов.
