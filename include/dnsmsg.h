...
/* 0 — есть адреса; -2 — ответ настоящий, но брать нечего (запрос,
   NXDOMAIN, пустой AAAA); -1 — пакет испорчен. Различать важно: без
   этого обычная пустота выглядит в счётчиках как сбой разбора. */
