...
static void send_login(int fd, const char *message)
{
    ...
    snprintf(page, sizeof(page),
        ...
        /* Та же аврора, что на странице: рубин у лисы, фиолет в глубине. */
        "body::before{content:'';position:fixed;inset:0;z-index:-1;pointer-events:none;"
        "background:radial-gradient(700px 480px at 50%% 10%%,rgba(196,48,79,.22),transparent 62%%),"
        ...
        "h1{margin:0 0 4px;text-align:center;color:#ef6b87;text-shadow:0 0 18px rgba(196,48,79,.45);"
        ...
        "input:focus{outline:0;border-color:#ef6b87;box-shadow:0 0 0 3px rgba(196,48,79,.2)}"
        "button{width:100%%;margin-top:20px;background:linear-gradient(180deg,#d94a68,#a52140);"
        "color:#fff0f3;border:0;border-radius:11px;padding:12px;font-family:inherit;font-size:15px;"
        "font-weight:650;line-height:1;cursor:pointer;"
        "box-shadow:inset 0 1px 0 rgba(255,255,255,.25),0 8px 24px rgba(196,48,79,.4)}"
