...
static void send_login(int fd, const char *message)
{
    ...
    snprintf(page, sizeof(page),
        ...
        "background:radial-gradient(700px 480px at 50%% 10%%,rgba(184,124,20,.22),transparent 62%%),"
        ...
        "h1{margin:0 0 4px;text-align:center;color:#d0932a;text-shadow:0 0 18px rgba(184,124,20,.45);"
        ...
        "input:focus{outline:0;border-color:#d0932a;box-shadow:0 0 0 3px rgba(184,124,20,.22)}"
        "button{width:100%%;margin-top:20px;background:linear-gradient(180deg,#d9a032,#a5721a);"
        ...
        "box-shadow:inset 0 1px 0 rgba(255,255,255,.3),0 8px 24px rgba(184,124,20,.4)}"
