...
static void send_login(int fd, const char *message)
{
    ...
    snprintf(page, sizeof(page),
        ...
        /* Та же аврора, что на странице: бирюза у лисы, фиолет в глубине. */
        "body::before{content:'';position:fixed;inset:0;z-index:-1;pointer-events:none;"
        "background:radial-gradient(700px 480px at 50%% 10%%,rgba(34,200,230,.22),transparent 62%%),"
        ...
        "filter:drop-shadow(0 0 14px rgba(34,200,230,.5));animation:breathe 5s ease-in-out infinite}"
        "@keyframes breathe{0%%,100%%{filter:drop-shadow(0 0 10px rgba(34,200,230,.45))}"
        "50%%{filter:drop-shadow(0 0 24px rgba(34,200,230,.6))}}"
        ...
        "h1{margin:0 0 4px;text-align:center;color:#22c8e6;text-shadow:0 0 18px rgba(34,200,230,.45);"
        ...
        "input:focus{outline:0;border-color:#22c8e6;box-shadow:0 0 0 3px rgba(34,200,230,.18)}"
        "button{width:100%%;margin-top:20px;background:linear-gradient(180deg,#3fd6f0,#17b6d4);"
        "color:#04222a;border:0;border-radius:11px;padding:12px;font-family:inherit;font-size:15px;"
        "font-weight:650;line-height:1;cursor:pointer;"
        "box-shadow:inset 0 1px 0 rgba(255,255,255,.35),0 8px 24px rgba(34,200,230,.4)}"
        "button:hover{filter:brightness(1.06)}"
        ".bad{color:#ff6b8a;font-size:13px;margin-top:14px}"
        "</style>"
