...
// Оставлено только то, что нужно клиенту VLESS на роутере Keenetic.
//
// Выброшено: wireguard (тянет gvisor), vmess, trojan, shadowsocks, dokodemo,
// http, loopback, fakedns, geodata, metrics, reverse, observatory, commander
// со всеми командными сервисами (тянет gRPC-сервер), kcp, парсеры toml и yaml,
